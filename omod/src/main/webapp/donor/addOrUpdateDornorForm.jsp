...
<openmrs:require privilege="All Blood Bank" otherwise="/login.htm" redirect="/module/blood_donation/main.form" />
...
<div id="wrapper">
    <div id="leftCol" style="float:left; min-width:500px">
        <form class="box" id="addDonorForm" method="post">
            ...
            <div>
                <div>
                    <div style="margin-top:12px;"><spring:message code="blood_donation.donor.name"/></div>
				...
				<div style="margin-top:12px;"><spring:message code="blood_donation.donor.fatherhusbandname"/></div>
				...
				<div style="margin-top:12px;display: inline-table;"><spring:message code="blood_donation.patient.id"/>&nbsp;&nbsp;&nbsp;</div><div style="margin-top:12px;display: inline-table;"><b>${patientIdentifier }</b></div>
			...
			<div>
				<div style="margin-top:12px;margin-bottom:2px;display: inline-table;"><spring:message code="blood_donation.donor.id"/>&nbsp;&nbsp;&nbsp;</div><div id="donIdShow" style="margin-top:12px;display: inline-table;"><b>${donorIdentifier }</b></div>
				<div style="margin-top:12px;display: inline-table;"><input  style="margin-top:12px;display: inline-table;" type="checkbox" name="preregistered" id="preregistered" onchange="openIdField();" value="" ><spring:message code="blood_donation.preregistered.id"/></div>
			...
			<div>
				<div style="display: inline-table;margin-top:12px;"><spring:message code="blood_donation.donor.gender"/></div>
				...
				<div style="display: inline-table;margin-top:12px;"><spring:message code="blood_donation.donor.dob"/></div>
				...
				<input  style="margin-top:12px;display: inline-table;" type="checkbox" name="dobEstimated" id="dobEstimated" value="yes" ><spring:message code="blood_donation.dob.etimated"/><div id="dateFieldMsg">dd/mm/yyyy</div>
			</div>
			<div>
				<div style="margin-top:12px;"><spring:message code="blood_donation.donor.address1"/></div>
				<div><input type="text" id="donorAddress1" name="donorAddress1" value="" onblur="validateForm();" style="width:600px;"/></div>

				 <div style="margin-top:12px;"><spring:message code="blood_donation.donor.address2"/></div>
				<div><input type="text" id="donorAddress2" name="donorAddress2" value=""  style="width:600px;"/></div>
				<div style="display: none;">
					<div><spring:message code="blood_donation.donor.cityVillage"/></div>
					<div><input type="text" id="cityVillage" name="cityVillage" value="" style="width:600px;"/></div>
					<div><spring:message code="blood_donation.donor.neighborhoodCell"/></div>
					<div><input type="text" id="neighborhoodCell" name="neighborhoodCell" value="" style="width:600px;"/></div>
					<div><spring:message code="blood_donation.donor.countyDistrict"/></div>
					<div><input type="text" id="countyDistrict" name="countyDistrict" value="" style="width:600px;"/></div>
					<div><spring:message code="blood_donation.donor.townshipDivision"/></div>
					<div><input type="text" id="townshipDivision" name="townshipDivision" value="" style="width:600px;"/></div>
					<div><spring:message code="blood_donation.donor.region"/></div>
					<div><input type="text" id="region" name="region" value="" style="width:600px;"/></div>
					<div><spring:message code="blood_donation.donor.subregion"/></div>
					<div><input type="text" id="subregion" name="subregion" value="" style="width:600px;"/></div>
					<div><spring:message code="blood_donation.donor.stateProvince"/></div>
					<div><input type="text" id="stateProvince" name="stateProvince" value="" style="width:600px;"/></div>
					<div><spring:message code="blood_donation.donor.country"/></div>
					<div><input type="text" id="country" name="country" value="" style="width:600px;"/></div>
					<div><spring:message code="blood_donation.donor.postalCode"/></div>
...
<script>
    jQuery(document).ready(function(){
        ...
        jQuery("#donorDob").datepicker({
            showOn: 'button',
            buttonImage: '${pageContext.request.contextPath}/moduleResources/blood_donation/styles/images/calendar.gif',
    ...
    //ajax images to show
    var ajax_load = "<img src='${pageContext.request.contextPath}/moduleResources/blood_donation/scripts/jquery/css/images/ui-anim_basic_16x16.gif' alt='loading...' />";
    var ajax_ok = "<img src='${pageContext.request.contextPath}/moduleResources/blood_donation/scripts/jquery/css/images/right-icon14.gif' alt='loading...' />";
    var ajax_wrong = "<img src='${pageContext.request.contextPath}/moduleResources/blood_donation/scripts/jquery/css/images/wrong-icon5.gif' alt='loading...' />";
...
<script type="text/javascript" src="${pageContext.request.contextPath}/moduleResources/blood_donation/scripts/jquery/js/jquery-1.4.2.min.js"></script>

<openmrs:require privilege="Add Donor" otherwise="/login.htm" redirect="/module/blood_donation/main.form" />

donor reg

<div id="display" name="display"></div>
<h2>
    <spring:message code="blood_donation.add.donor" />
</h2>
<br/>
<form class="box" id="addDonorForm" method="post">
    <table >
        <tr>
            <td><spring:message code="blood_donation.donor.name"/></td>
